        ...
        for (int i {0}; i < 8; ++i){
            ...
            switch(i){
                ...
                case 5:
                    ...
                    break;
                case 6:
                    altTile = rotate(rotate(tileSet.second, 1), 2);
                    break;
                case 7:
                    altTile = flip(rotate(rotate(tileSet.second, 1), 2));
                    break;
            }
            ...
            //if (topLeft == -2){
                ...
                if (found /*&& tileSet.first != topRight && tileSet.first != botLeft && tileSet.first != botRight*/)
                    topLeft.push_back(tileSet.first);
            //}
           ...
           // if (topRight == -1){
                ...
                if (found/* && tileSet.first != topLeft && tileSet.first != botLeft && tileSet.first != botRight*/)
                    topRight.push_back(tileSet.first);
            //}
            ...
            //if (botLeft == -4){
                ...
                if (found/* && tileSet.first != topLeft && tileSet.first != topRight && tileSet.first != botRight*/)
                    botLeft.push_back(tileSet.first);
            //}
            ...
            //if (botRight == -3){
                ...
                if (found/* && tileSet.first != topLeft && tileSet.first != topRight && tileSet.first != botLeft*/){
                    std::cout << tileSet.first << '\n';
                    for (auto ele : altTile)
                        std::cout << ele << '\n';
                    botRight.push_back(tileSet.first);
                }
            //}
